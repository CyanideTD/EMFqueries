...
public class Result {
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < mfs.size(); i++) {
			MFStructure mf = mfs.get(i);
			if (!((mf.getMf1_sum_quant() / mf.getMf1_count_quant()) > (mf.getMf2_sum_quant() / mf.getMf2_count_quant())
					&& (mf.getMf1_sum_quant() / mf.getMf1_count_quant()) > (mf.getMf3_sum_quant()
							/ mf.getMf3_count_quant()))) {
				mfs.remove(i);
				i--;
			}
		}
		...
		for (int i = 0; i < mfs.size(); i++) {
			...
			System.out.printf("%11f",
					Double.parseDouble(mf.getMf1_sum_quant() + "") / Double.parseDouble(mf.getMf1_count_quant() + ""));
			System.out.print("    ");
			System.out.printf("%11f",
					Double.parseDouble(mf.getMf2_sum_quant() + "") / Double.parseDouble(mf.getMf2_count_quant() + ""));
			System.out.print("    ");
			System.out.printf("%11f",
					Double.parseDouble(mf.getMf3_sum_quant() + "") / Double.parseDouble(mf.getMf3_count_quant() + ""));
			System.out.print("    ");
			System.out.println("");
		}
